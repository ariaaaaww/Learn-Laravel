                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="{{ route('home') }}" active="{{ request()->is('home') ? 'true' : 'false' }}"
                                class="
                                {{ request()->is('home') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}                      
                                       rounded-md  px-3 py-2 text-sm font-medium">Home</a>
                            <a href="{{ route('about') }}" active="{{ request()->is('home') ? 'true' : 'false' }}"
                                class="
                                 {{ request()->is('about') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}
                                rounded-md px-3 py-2 text-sm font-medium">About</a>
                            <a href="{{ route('blog') }}" active="{{ request()->is('home') ? 'true' : 'false' }}"
                                class="
                                {{ request()->is('blog') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}
                                rounded-md px-3 py-2 text-sm font-medium">Blog</a>
                            <a href="{{ route('contact') }}" active="{{ request()->is('home') ? 'true' : 'false' }}"
                                class="
                                {{ request()->is('contact') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}
